-- Dado FICTÍCIO de demonstração (Janeiro a Junho 2026) — candidatos e
-- percentuais inventados para exercitar dashboard/testes com uma série
-- temporal plausível. NUNCA carregar fora de ambiente de teste: init_db()
-- só executa este arquivo quando TESTING=True ou force_seed=True (ver
-- db/core.py). Se isso for parar em produção, contamina o dashboard público
-- com pesquisas que não existem (incidente de 2026-07-21 — ver memória do
-- projeto).
